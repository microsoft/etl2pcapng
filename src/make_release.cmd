...
"C:/Program Files (x86)/WiX Toolset v3.11/bin/candle.exe" installer.wxs -o etl2pcapng\x64\etl2pcapng.wixobj
"C:/Program Files (x86)/WiX Toolset v3.11/bin/light.exe" -b etl2pcapng\x64 -o etl2pcapng\x64\etl2pcapng.msi etl2pcapng\x64\etl2pcapng.wixobj
